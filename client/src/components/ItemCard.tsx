...
const ItemCard: React.FC<ItemProps> = ({ item, onClick }) => {
    ...
    return (
        <motion.div
            ...
            whileHover="hover"
            whileTap={{ scale: 0.98 }}
            className="bg-white border border-gray-100 rounded-[3rem] overflow-hidden cursor-pointer group shadow-sm hover:shadow-layered transition-all duration-700 isolate"
            onClick={onClick}
        >
